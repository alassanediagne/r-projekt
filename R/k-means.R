...
#'@param max_iter (optional) int. Legt maximale Anzahl an Iterationen fest. Default: 50
#'@param tol: (optional) float. Toleranz zur Festlegung der Konvergenz. Default: 1e-8
#'@export
...
plot_kmeans_clusters <- function(data, num_cluster){
